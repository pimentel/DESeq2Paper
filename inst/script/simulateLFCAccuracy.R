...
library("edgeR")
library("Biobase")
algos <- list("DESeq2"=runDESeq2,"edgeR"=runEdgeR,"GFOLD"=runGFOLD)
...
methods <- c("DESeq2","GFOLD","edgeR predFC","edgeR predFC10")
...
save(res, file="../../data/results_simulateLFCAccuracy.RData")
